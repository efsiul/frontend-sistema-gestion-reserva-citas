		...
		<div id="slider" className="carousel slide" data-ride="carousel">
			...
			<div className="carousel-inner">
				<div className="carousel-item active">
					<img className="img-fluid" src="https://imagenes.20minutos.es/files/image_990_v3/uploads/imagenes/2021/05/05/app-ligar-1.png" />
				...
				<div className="carousel-item">
					<img className="img-fluid" width="140" height="140" src="https://blog.nubecolectiva.com/wp-content/uploads/2019/10/edit_img_destacada_blog_devs-3-930x360.png"/>
					<div className="elementos">
